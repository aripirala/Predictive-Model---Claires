"""
Created on Wed Jan 24 09:43:36 2018
...
FILE_PATH_INPUT = 'W:/B&M/Store Segmentation/Pete/Learning/Git/Predictive-Model---Claires/SWI-Sales_Predictive_Model/4. LM without Weather + Lasso/Input_Data/'

FILE_PATH_OUTPUT = 'W:/B&M/Store Segmentation/Pete/Learning/Git/Predictive-Model---Claires/SWI-Sales_Predictive_Model/4. LM without Weather + Lasso/Output_Data/'
...
closed_stores_list = [] #### Add any Swiss stores due to close, check stock builds
...
ax = lasso_output_df2.plot(kind='bar', title ="Switzerland Coefficient Variables [alpha_1]", figsize=(15, 10), edgecolor='black',  legend=False,  fontsize=12)
