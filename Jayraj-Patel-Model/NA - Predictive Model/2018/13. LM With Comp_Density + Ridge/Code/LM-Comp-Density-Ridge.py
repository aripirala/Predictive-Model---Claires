# -*- coding: utf-8 -*-
"""
Created on Thu Jul 26 10:23:52 2018
...
FILE_PATH_INPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/13. LM With Comp_Density + Ridge/Input Data/'

FILE_PATH_OUTPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/13. LM With Comp_Density + Ridge/Output Data/'
...
comp_df = pd.read_excel(FILE_PATH_INPUT+'1st Model Miles Radius Analysis.xlsx', sheetname='Data')
...
features = ['Transaction_Date', 'Transaction_Count',
       ...
       'Holiday_Event', 'Holiday_Period', 'Promo', 'Sales_Promo', 'Cluster', "Justice (<1)", "Piercing Pagoda (<1)", 
                             "H&M (<1)", "Zara (<1)", "1 Competitor", "2 Competitors", "3 Competitors"]
...
lasso_output_df = pd.read_csv(FILE_PATH_INPUT + 'Comp_Density_Lasso_Output.csv', skiprows = 2, header = None, engine = 'python')
...
ridge_output_df.to_csv(FILE_PATH_OUTPUT+'Comp_Density_Ridge_Output.csv',index=False)
