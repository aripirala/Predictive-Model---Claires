# -*- coding: utf-8 -*-
"""
Created on Thu Jul 26 10:46:05 2018
...
FILE_PATH_INPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/15. LM With Miles_Density + Ridge/Input Data/'

FILE_PATH_OUTPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/15. LM With Miles_Density + Ridge/Output Data/'
...
features = ['Transaction_Date', 'Transaction_Count',
       ...
       'Holiday_Event', 'Holiday_Period', 'Promo', 'Sales_Promo', 'Cluster', "Justice (<1)", "Justice (<5)", "Justice (<10)", "Piercing Pagoda (<1)", "Piercing Pagoda (<5)", 
                             "Piercing Pagoda (<10)", "H&M (<1)", "H&M (<5)", "H&M (<10)", 
                             "Zara (<1)", "Zara (<5)", "Zara (<10)", "1 Competitor", "2 Competitors", "3 Competitors"]
...
lasso_output_df = pd.read_csv(FILE_PATH_INPUT + 'Miles_Density_Lasso_Output.csv', skiprows = 2, header = None, engine = 'python')
