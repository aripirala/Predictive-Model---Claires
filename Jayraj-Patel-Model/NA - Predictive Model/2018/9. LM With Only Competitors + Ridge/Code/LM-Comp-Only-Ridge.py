# -*- coding: utf-8 -*-
"""
Created on Wed Jul 25 16:41:46 2018
...
FILE_PATH_INPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/9. LM With Only Competitors + Ridge/Input Data/'

FILE_PATH_OUTPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/9. LM With Only Competitors + Ridge/Output Data/'
...
lasso_output_df = pd.read_csv(FILE_PATH_INPUT + 'Comp_Only_Lasso_Output.csv', skiprows = 2, header = None, engine = 'python')
...
ridge_output_df.to_csv(FILE_PATH_OUTPUT+'Comp_Only_Ridge_Output.csv',index=False)
