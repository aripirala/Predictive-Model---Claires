# -*- coding: utf-8 -*-
"""
Created on Thu Jul 19 10:53:59 2018
...
FILE_PATH_INPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/5. LM Without Weather + Ridge/Input Data/'

FILE_PATH_OUTPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/5. LM Without Weather + Ridge/Output Data/'
...
lasso_output_df = pd.read_csv(FILE_PATH_INPUT + 'Lasso_Output.csv', skiprows = 2, header = None, engine = 'python')
...
### Root Mean squared error: 658.82    
### Variance score: 0.66                          ####   
...
ridge_output_df.to_csv(FILE_PATH_OUTPUT+'Ridge_Output.csv',index=False)
