# -*- coding: utf-8 -*-
"""
Created on Thu Jul 26 13:41:13 2018
...
FILE_PATH_INPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/18. LM Old With Holiday + Lasso/Input Data/'

FILE_PATH_OUTPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/18. LM Old With Holiday + Lasso/Output Data/'
...
comp_df = pd.read_excel(FILE_PATH_INPUT+'Miles Radius Analysis-Boolean-NoZara.xlsx', sheetname='Data')
...
#        'Open Hours',
#       'Holiday_Event', 'Holiday_Period', 'Promo', 'Sales_Promo', 'Cluster', "Justice (<1)", "Piercing Pagoda (<1)", 
#                               "H&M (<1)",
#                             'Justice_only', 'PP_only', 'HM_only'] #, "Competitor Density (<1)"]



features = ['Transaction_Date', 'Transaction_Count',
        'Open Hours',
       'Holiday_Event', 'Holiday_Period', 'Promo', 'Sales_Promo', 'Cluster', '1 Competitor', '2 Competitors', '3 Competitors'] 
...
#features = [ 'Transaction_Date', 'Transaction_Count',
#        'Open Hours',
#       'Holiday_Event', 'Holiday_Period', 'Promo', 'Sales_Promo', 'Cluster', 'miniso_min0_max1', 'miniso_min1_max5',
#       'miniso_min5_max10', 'justice_min0_max1', 'justice_min1_max5',
#       'justice_min5_max10', 'hm_min0_max1', 'hm_min1_max5', 'hm_min5_max10',
#       'zara_min0_max1', 'zara_min1_max5', 'zara_min5_max10',
#       'pagoda_min0_max1', 'pagoda_min1_max5', 'pagoda_min5_max10']

#features = [ 'Transaction_Date', 'Transaction_Count',
#        'Open Hours',
#       'Holiday_Event', 'Holiday_Period', 'Promo', 'Sales_Promo', 'Cluster',  'justice_min0_max1',  'hm_min0_max1', 'miniso_min0_max1',
#       'zara_min0_max1', 
#       'pagoda_min0_max1' ]
...
Est_StdSca_Lasso_list = [Ridge(normalize=False,max_iter=5000, alpha=a, random_state=123) for a in [0.1,1,10]]
...
lasso_output_df.to_csv(FILE_PATH_OUTPUT+'Holiday_Ridge_Output11-Temp.csv',index=False)