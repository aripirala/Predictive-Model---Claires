# -*- coding: utf-8 -*-
"""
Created on Tue Jul 24 13:50:16 2018
...
features = ['Transaction_Date', 'Transaction_Count',
       ...
       'Holiday_Event', 'Holiday_Period', 'Promo', 'Sales_Promo', 'Cluster', "Justice (<1)", "Piercing Pagoda (<1)", 
                              "Miniso (<1)", "H&M (<1)",
                             "Zara (<1)", "Competitor Density (<1)", "Competitor Density (<5)", "Competitor Density (<10)"]
#features = ['Transaction_Date', 'Transaction_Count',
#        'Open Hours',
...
lasso_output_df = pd.read_csv(FILE_PATH_INPUT + 'Holiday_Lasso_Output.csv', skiprows = 2, header = None, engine = 'python')
...
ridge_output_df.to_csv(FILE_PATH_OUTPUT+'Comp_Ridge_Output.csv',index=False)
