# -*- coding: utf-8 -*-
"""
Created on Mon Jul 16 13:22:56 2018
...
sales_df = pd.read_excel(FILE_PATH_INPUT+'Sales-StoreHours-Hol-Promo-NoOutlier.xlsx', sheetname='Data')
...
plt.savefig(FILE_PATH_OUTPUT+'Sales vs Qty-Kmeans-NoOutlier.png')
