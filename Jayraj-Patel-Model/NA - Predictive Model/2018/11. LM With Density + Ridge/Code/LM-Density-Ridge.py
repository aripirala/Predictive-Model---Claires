# -*- coding: utf-8 -*-
"""
Created on Wed Jul 25 17:02:15 2018
...
FILE_PATH_INPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/11. LM With Density + Ridge/Input Data/'

FILE_PATH_OUTPUT = 'C:/Users/patelj/Documents/Project/Predictive-Model---Claires/Jayraj-Patel-Model/NA - Predictive Model/2018/11. LM With Density + Ridge/Output Data/'
...
comp_df = pd.read_excel(FILE_PATH_INPUT+'Competitive Density Output.xlsx', sheetname='Data')
...
lasso_output_df = pd.read_csv(FILE_PATH_INPUT + 'Density_Lasso_Output.csv', skiprows = 2, header = None, engine = 'python')
...
ridge_output_df.to_csv(FILE_PATH_OUTPUT+'Density_Ridge_Output.csv',index=False)
