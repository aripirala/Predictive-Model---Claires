# -*- coding: utf-8 -*-
"""
Created on Mon Jul 23 09:21:01 2018
...
FILE_PATH_OUTPUT = 'C:/Users/patelj/Documents/Lat-Longs/Pagoda Analysis/'

R = 6373.0
pagoda_df = pd.read_excel(FILE_PATH_INPUT+'Pagoda-Lat-Long.xlsx', sheetname='Data')
...
for x in range(0,1276):
    ...
    for i in range(0,594):
        lat2 = pagoda_df["Latitude"].values[i]
        lon2 = pagoda_df["Longitude"].values[i]
        lat2 = radians(lat2)
        lon2 = radians(lon2)
...
new_list = new_list.reshape(1276,594)

dist_output_df = pd.DataFrame(new_list)        
dist_output_df.to_excel(FILE_PATH_OUTPUT+'Pagoda Distance Output.xlsx')
