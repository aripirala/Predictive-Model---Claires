"""
Created on Tue Jan 23 11:19:15 2018
...
FILE_PATH_INPUT = 'W:/B&M/Store Segmentation/Pete/Learning/Git/Predictive-Model---Claires/SPA-Sales_Predictive_Model/4. LM without Weather + Lasso/Input_Data/'

FILE_PATH_OUTPUT = 'W:/B&M/Store Segmentation/Pete/Learning/Git/Predictive-Model---Claires/SPA-Sales_Predictive_Model/4. LM without Weather + Lasso/Output_Data/'
...
closed_stores_list = [] #Add any Spanish stores due to close, check stock builds
...
#### Root Mean squared error: 409.78    
#### Variance score: 0.55
...
#### Sort Values, drop Score and Intercept, Plot Graph #############################################
...
ax = lasso_output_df2.plot(kind='bar', title ="Spain Coefficient Variables [alpha_1]", figsize=(15, 10), edgecolor='black',  legend=False,  fontsize=12)
