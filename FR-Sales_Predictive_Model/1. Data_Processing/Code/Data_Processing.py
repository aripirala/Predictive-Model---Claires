...
hol_df = pd.read_excel(FILE_PATH_INPUT+'Holiday_Data.xlsm', sheet_name='Holiday_Data')
sales_df = pd.read_excel(FILE_PATH_INPUT+'Sales_Data.xlsm', sheet_name='Sales_Data')
store_hours_df = pd.read_excel(FILE_PATH_INPUT+'Store_Hours_Data.xlsm', sheet_name='Store_Hours')
